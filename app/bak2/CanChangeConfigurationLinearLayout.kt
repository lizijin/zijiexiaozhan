...
abstract class CanChangeConfigurationLinearLayout @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : LinearLayout(context, attrs), CanChangeConfigurationView {
    ...
    final override fun changeConfiguration(typedArray: TypedArray) {
