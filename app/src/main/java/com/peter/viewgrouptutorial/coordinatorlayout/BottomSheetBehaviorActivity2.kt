...
/**
 * 当BottomBehavior对应的Layout 不是CoordinatorLayout的topmost child时，但是BottomBehavior有NestedScrollingChild
 */
class BottomSheetBehaviorActivity2 : AppCompatActivity() {
    lateinit var bottomBehaviorLayout: LinearLayout
    private lateinit var bottomSheetBehavior: BottomSheetBehavior<LinearLayout>
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bottom_sheet_behavior2)
