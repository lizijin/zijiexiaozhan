...
/**
 * 当BottomBehavior对应的Layout 不是CoordinatorLayout的topmost child时，但是BottomBehavior没有NestedScrollingChild
 */
class BottomSheetBehaviorActivity3 : AppCompatActivity() {
    lateinit var bottomBehaviorLayout: LinearLayout
    private lateinit var bottomSheetBehavior: BottomSheetBehavior<LinearLayout>
    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bottom_sheet_behavior3)
