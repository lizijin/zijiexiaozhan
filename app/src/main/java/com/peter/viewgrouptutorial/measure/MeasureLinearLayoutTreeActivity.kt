...
class MeasureLinearLayoutTreeActivity : AppCompatActivity() {
...
//        setContentView(R.layout.activity_measure_tree)
        ...
        val vp2 = MeasureLinearLayout(this)
        vp2.orientation= LinearLayout.VERTICAL
        vp2.addView(view1)
        vp2.addView(view2)
        vp2.addView(view3)
        ...
        val vp3 = MeasureLinearLayout(this)
        vp3.addView(view4)
        vp3.addView(view5)
        vp3.addView(view6)
        ...
        val vp4 = MeasureLinearLayout(this)
        vp4.addView(view7)
        vp4.addView(view8)
        vp4.addView(view9)

        val vp1 = MeasureLinearLayout(this)
//        vp1.addView(vp2)
//        vp1.addView(vp3)
//        vp1.addView(vp4)
