...
public class DimensionCalculator {
  ...
  private void initMarginRect(Rect marginRect, MarginLayoutParams marginLayoutParams) {
    Log.e("jiangxuanyu", "leftMargin "+marginLayoutParams.leftMargin+" topMargin "+
            marginLayoutParams.topMargin+" rightMargin "+
            marginLayoutParams.rightMargin+" bottomMargin "+
